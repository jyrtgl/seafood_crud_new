...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($name_err) && empty($age_err) && empty($birthdate_err) && empty($email_err) && empty($contactnumber_err) && empty($gender_err) && empty($password_err)){
        ...
        $sql = "INSERT INTO `staff`(`Username`, `Name`, `Age`, `Birthdate`, `Email`, `Contact Number`, `Gender`, `Password`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h2>Create Record Staff</h2>
                    </div>
                    <p>Please fill this form and submit to add <b>staff</b> record to the database.</p>
