...
<body>
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <li><a href="index.php"><span class="glyphicon glyphicon-user"></span> Customer</a></li>
    ...
    <div class="container">
        <div class="page-header clearfix">
            ...
            <a href="createstaff.php" class="btn btn-success pull-right btn-lg">Add New Staff</a>
        </div>

        <div class="form-inline">
        <center>
            <form method="post" action="index2.php"  class="col-xs-14" >
        ...
        if (!empty($_REQUEST['term'])) {
            ...
            $sql = "SELECT * FROM `staff` WHERE `Username` LIKE '%".$term."%' OR `Name` LIKE '%".$term."%' OR `Age` LIKE '%".$term."%' OR `Birthdate` LIKE '%".$term."%' OR `Email` LIKE '%".$term."%' OR `Contact Number` LIKE '%".$term."%' OR `Gender` LIKE '%".$term."%'";
